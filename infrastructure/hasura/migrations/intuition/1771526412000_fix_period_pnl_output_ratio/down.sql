-- Rollback: restore period functions to state from migration 1771526411000
-- (which already uses output-ratio after in-place edit).
-- To fully revert to binary PnL split, also rollback 1771526411000.

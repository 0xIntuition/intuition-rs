-- Revert daily bucket alignment fix
-- Restores functions to their previous versions from migrations:
--   - get_pnl_leaderboard_period: from 1771526401000
--   - get_vault_leaderboard_period: from 1770384691000
--   - get_pnl_leaderboard: from 1771526402000

-- ========================================
-- REVERT get_pnl_leaderboard_period
-- (to version from 1771526401000 + sort aliases from 1771526402000)
-- ========================================
...
-- ========================================
-- REVERT get_vault_leaderboard_period
-- (to version from 1770384691000)
-- ========================================
...
-- ========================================
-- REVERT get_pnl_leaderboard
-- (to version from 1771526402000)
-- ========================================

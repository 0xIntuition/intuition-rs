-- Migration: Use share_price_change_stats_hourly cagg for price lookups.
--
-- Bottleneck (~56s): prices_at_start/end scan raw share_price_change (371K rows)
...
--
-- Position data (Step 2) is unchanged from migration 1771526424000 — the DISTINCT ON
-- approach over position_cumulative_hourly remains the best approach for that step.

...
CREATE INDEX IF NOT EXISTS atom_log_index_idx ON atom(log_index);
CREATE INDEX IF NOT EXISTS vault_block_number_idx ON vault(block_number);
CREATE INDEX IF NOT EXISTS vault_log_index_idx ON vault(log_index);
CREATE INDEX IF NOT EXISTS vault_transaction_hash_idx ON vault(transaction_hash);
CREATE INDEX IF NOT EXISTS vault_current_share_price_idx ON vault(current_share_price);
CREATE INDEX IF NOT EXISTS vault_position_count_idx ON vault(position_count);
CREATE INDEX IF NOT EXISTS vault_total_shares_idx ON vault(total_shares);
CREATE INDEX IF NOT EXISTS vault_created_at_idx ON vault(created_at);
CREATE INDEX IF NOT EXISTS vault_updated_at_idx ON vault(updated_at);
CREATE INDEX IF NOT EXISTS fee_transfer_block_number_idx ON fee_transfer(block_number);
CREATE INDEX IF NOT EXISTS fee_transfer_transaction_hash_idx ON fee_transfer(transaction_hash);
CREATE INDEX IF NOT EXISTS fee_transfer_created_at_idx ON fee_transfer(created_at);
CREATE INDEX IF NOT EXISTS deposit_block_number_idx ON deposit(block_number);
CREATE INDEX IF NOT EXISTS deposit_transaction_hash_idx ON deposit(transaction_hash);
CREATE INDEX IF NOT EXISTS deposit_log_index_idx ON deposit(log_index);
CREATE INDEX IF NOT EXISTS deposit_vault_type_idx ON deposit(vault_type);
CREATE INDEX IF NOT EXISTS deposit_created_at_idx ON deposit(created_at);
CREATE INDEX IF NOT EXISTS redemption_block_number_idx ON redemption(block_number);
CREATE INDEX IF NOT EXISTS redemption_transaction_hash_idx ON redemption(transaction_hash);
CREATE INDEX IF NOT EXISTS redemption_log_index_idx ON redemption(log_index);
CREATE INDEX IF NOT EXISTS redemption_created_at_idx ON redemption(created_at);
CREATE INDEX IF NOT EXISTS position_account_vault_idx ON position(account_id, term_id);
CREATE INDEX IF NOT EXISTS position_shares_idx ON position(shares);
CREATE INDEX IF NOT EXISTS position_block_number_idx ON position(block_number);
CREATE INDEX IF NOT EXISTS position_log_index_idx ON position(log_index);
CREATE INDEX IF NOT EXISTS position_transaction_hash_idx ON position(transaction_hash);
CREATE INDEX IF NOT EXISTS position_transaction_index_idx ON position(transaction_index);

-- Basic schema foreign key indexes
CREATE INDEX IF NOT EXISTS idx_atom_creator ON atom(creator_id);
CREATE INDEX IF NOT EXISTS idx_atom_vault ON atom(term_id);
CREATE INDEX IF NOT EXISTS idx_term_created_at ON term(created_at);
CREATE INDEX IF NOT EXISTS idx_triple_creator ON triple(creator_id);
CREATE INDEX IF NOT EXISTS idx_triple_subject ON triple(subject_id);
CREATE INDEX IF NOT EXISTS idx_triple_predicate ON triple(predicate_id);
CREATE INDEX IF NOT EXISTS idx_triple_object ON triple(object_id);
CREATE INDEX IF NOT EXISTS idx_vault_atom ON vault(term_id);
CREATE INDEX IF NOT EXISTS idx_vault_triple ON vault(term_id);
CREATE INDEX IF NOT EXISTS idx_fee_transfer_sender ON fee_transfer(sender_id);
CREATE INDEX IF NOT EXISTS idx_fee_transfer_receiver ON fee_transfer(receiver_id);
CREATE INDEX IF NOT EXISTS idx_deposit_sender ON deposit(sender_id);
CREATE INDEX IF NOT EXISTS idx_deposit_receiver ON deposit(receiver_id);
CREATE INDEX IF NOT EXISTS idx_deposit_vault ON deposit(term_id);
CREATE INDEX IF NOT EXISTS idx_redemption_sender ON redemption(sender_id);
CREATE INDEX IF NOT EXISTS idx_redemption_receiver ON redemption(receiver_id);
CREATE INDEX IF NOT EXISTS idx_redemption_vault ON redemption(term_id);
CREATE INDEX IF NOT EXISTS idx_position_account ON position(account_id);
CREATE INDEX IF NOT EXISTS idx_position_vault ON position(term_id);
CREATE INDEX IF NOT EXISTS idx_predicate_object_predicate ON predicate_object(predicate_id);
CREATE INDEX IF NOT EXISTS idx_predicate_object_object ON predicate_object(object_id);
CREATE INDEX IF NOT EXISTS idx_subject_predicate_subject ON subject_predicate(subject_id);
CREATE INDEX IF NOT EXISTS idx_subject_predicate_predicate ON subject_predicate(predicate_id);
CREATE INDEX IF NOT EXISTS idx_signal_account ON signal(account_id);
CREATE INDEX IF NOT EXISTS idx_signal_atom ON signal(atom_id);
CREATE INDEX IF NOT EXISTS idx_signal_triple ON signal(triple_id);
CREATE INDEX IF NOT EXISTS idx_signal_created_at ON signal(created_at);
CREATE INDEX IF NOT EXISTS idx_atom_value_atom ON atom_value(id);
CREATE INDEX IF NOT EXISTS idx_atom_value_thing ON atom_value(thing_id);
CREATE INDEX IF NOT EXISTS idx_atom_value_person ON atom_value(person_id);
CREATE INDEX IF NOT EXISTS idx_atom_value_organization ON atom_value(organization_id);
CREATE INDEX IF NOT EXISTS idx_atom_value_book ON atom_value(book_id);
...
CREATE INDEX IF NOT EXISTS idx_thing_url ON thing(url);
CREATE INDEX IF NOT EXISTS idx_person_name ON person(name);
CREATE INDEX IF NOT EXISTS idx_person_description ON person(description);
CREATE INDEX IF NOT EXISTS idx_person_url ON person(url);
...
CREATE INDEX IF NOT EXISTS idx_organization_url ON organization(url);
CREATE INDEX IF NOT EXISTS idx_event_type ON event(type);
CREATE INDEX IF NOT EXISTS idx_event_atom ON event(atom_id);
CREATE INDEX IF NOT EXISTS idx_event_triple ON event(triple_id);
...
CREATE INDEX IF NOT EXISTS idx_event_transaction_hash ON event(transaction_hash);
...
CREATE INDEX IF NOT EXISTS idx_term_type ON term(type);
CREATE INDEX IF NOT EXISTS idx_term_atom_id ON term(atom_id);
CREATE INDEX IF NOT EXISTS idx_term_triple_id ON term(triple_id);
CREATE INDEX IF NOT EXISTS idx_total_market_cap ON term(total_market_cap);
CREATE INDEX IF NOT EXISTS idx_total_assets ON term(total_assets);

-- Vault structure indexes
CREATE INDEX IF NOT EXISTS idx_vault_term_id ON vault(term_id);
CREATE INDEX IF NOT EXISTS idx_curve_id ON vault(curve_id);
CREATE INDEX IF NOT EXISTS idx_vault_total_assets ON vault(total_assets);
CREATE INDEX IF NOT EXISTS idx_vault_market_cap ON vault(market_cap);
...
CREATE INDEX IF NOT EXISTS idx_triple_vault_total_shares ON triple_vault(total_shares);
CREATE INDEX IF NOT EXISTS idx_triple_vault_total_assets ON triple_vault(total_assets);
CREATE INDEX IF NOT EXISTS idx_triple_vault_position_count ON triple_vault(position_count);
CREATE INDEX IF NOT EXISTS idx_triple_vault_market_cap ON triple_vault(market_cap);
CREATE INDEX IF NOT EXISTS idx_triple_vault_block_number ON triple_vault(block_number);
CREATE INDEX IF NOT EXISTS idx_triple_vault_log_index ON triple_vault(log_index);
CREATE INDEX IF NOT EXISTS idx_triple_vault_updated_at ON triple_vault(updated_at);
...
CREATE INDEX IF NOT EXISTS idx_triple_term_total_assets ON triple_term(total_assets);
CREATE INDEX IF NOT EXISTS idx_triple_term_total_market_cap ON triple_term(total_market_cap);
CREATE INDEX IF NOT EXISTS idx_triple_term_updated_at ON triple_term(updated_at);
...
CREATE INDEX IF NOT EXISTS idx_share_price_change_term_updated_at ON share_price_change(updated_at);
CREATE INDEX IF NOT EXISTS idx_share_price_change_term_block_number ON share_price_change(block_number);
CREATE INDEX IF NOT EXISTS idx_share_price_change_term_transaction_hash ON share_price_change(transaction_hash);
CREATE INDEX IF NOT EXISTS idx_share_price_change_term_log_index ON share_price_change(log_index);

-- Initialize indexes
CREATE INDEX IF NOT EXISTS idx_initialize_block_number ON initialize(block_number);
CREATE INDEX IF NOT EXISTS idx_initialize_transaction_hash ON initialize(transaction_hash);

-- Failed logs indexes
CREATE INDEX IF NOT EXISTS idx_failed_logs_block_number ON failed_logs(block_number);
CREATE INDEX IF NOT EXISTS idx_failed_logs_transaction_hash ON failed_logs(transaction_hash);
CREATE INDEX IF NOT EXISTS idx_failed_logs_address ON failed_logs(address);
CREATE INDEX IF NOT EXISTS idx_failed_logs_block_timestamp ON failed_logs(block_timestamp);

-- Fix realized/unrealized PnL split in period leaderboard functions
-- Bug: realized_pnl was computed as redemptions - deposits (just negated cash flow)
-- Bug: unrealized_pnl == total_pnl always (algebraically identical formula)
-- Fix: Split total_pnl by whether position is closed (shares=0) or open (shares>0)
--      This matches the all-time leaderboard (get_pnl_leaderboard) logic.

-- ========================================
-- GLOBAL PERIOD LEADERBOARD
-- ========================================

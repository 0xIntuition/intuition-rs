-- Revert optimization: restore the previous version from
-- 1771526403000_fix_daily_bucket_alignment which introduced v_bucket_start/v_bucket_end
-- and the relevant_vaults CTE, but kept the three-CTE position scan structure.

DROP INDEX IF EXISTS idx_pcd_account_term_bucket;
DROP INDEX IF EXISTS idx_share_price_change_term_curve_block_asc;

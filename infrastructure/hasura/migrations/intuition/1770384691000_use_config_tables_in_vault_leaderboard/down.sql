-- Rollback: revert vault leaderboard functions to hardcoded constants
-- This restores the versions from migration 1770384690000_fix_pnl_leaderboard_entry_type

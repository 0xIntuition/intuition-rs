-- Update vault leaderboard functions to use fee_config and curve_config tables
-- instead of hardcoded fee constants and curve_id matching.
--
-- Changes:
--   get_vault_leaderboard:
--     - Uses fee_config for protocol_fee, exit_fee, fee_denominator, fee_threshold, default_curve_id
--     - Uses curve_config for curve_type ('linear'/'offset_progressive'), offset, half_slope
--     - Conditional exit fee based on fee_threshold (matching Solidity contract)
--     - Joins vault v_default for default curve's total_shares (fee threshold check)
--
--   get_vault_leaderboard_period:
--     - Uses fee_config for protocol_fee, exit_fee, fee_denominator
--     - Uses curve_config for curve_type, offset, half_slope
--     - Replaces hardcoded curve_id=1/2 with curve_type matching

-- ========================================
-- 1. VAULT-SPECIFIC ALL-TIME LEADERBOARD
-- ========================================
...
-- ========================================
-- 2. VAULT-SPECIFIC PERIOD LEADERBOARD
-- ========================================

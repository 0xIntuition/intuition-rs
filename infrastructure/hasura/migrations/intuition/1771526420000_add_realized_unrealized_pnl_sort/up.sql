-- Add sort_by options for realized_pnl, unrealized_pnl, realized_pnl_pct, unrealized_pnl_pct
-- The enriched CTE already computes these columns; this just wires them into the ranked CTE.

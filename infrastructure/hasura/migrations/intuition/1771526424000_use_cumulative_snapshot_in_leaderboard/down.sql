-- Restore get_pnl_leaderboard_period to the version from migration
-- 1771526422000_prefilter_protocol_accounts_and_shortcircuit.
-- This undoes the cumulative-snapshot Step 2 and brings back the
-- LATERAL full-history scan over position_change_daily.

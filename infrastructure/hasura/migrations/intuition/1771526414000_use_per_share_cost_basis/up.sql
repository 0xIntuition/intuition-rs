-- Switch from output-ratio to per-share cost basis for realized/unrealized PnL
--
-- The output-ratio method uses r = redemptions / (redemptions + equity_at_end)
-- to split both PnL and the denominator. This makes realized_pnl_pct and
-- unrealized_pnl_pct always equal (total_pnl / total_capital * 100).
--
-- Per-share cost basis fixes this:
...
--
-- Invariant preserved: realized_pnl + unrealized_pnl = total_pnl

-- Revert: drop the 11-param version, restore the 10-param version from 1771526409000

DROP FUNCTION IF EXISTS get_pnl_leaderboard_period(
  TIMESTAMPTZ, TIMESTAMPTZ, INTEGER, INTEGER, TEXT, TEXT, BOOLEAN, INTEGER, NUMERIC, TEXT, NUMERIC
);

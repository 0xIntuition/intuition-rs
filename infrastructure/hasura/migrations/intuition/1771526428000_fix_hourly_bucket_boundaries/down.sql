-- Revert to get_pnl_leaderboard_period from migration 1771526426000
-- (restores day-level v_bucket_start/v_bucket_end usage in Step 2)
...
BEGIN
  ...
  ---------------------------------------------------------------------------
  -- Step 2: Position data from cumulative snapshots
  ---------------------------------------------------------------------------

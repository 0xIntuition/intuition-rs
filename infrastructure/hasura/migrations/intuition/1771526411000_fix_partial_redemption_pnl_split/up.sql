...
--
-- Now uses a cost-basis proportional split (output-ratio method):
--   All-time:  total_redemptions / (total_redemptions + equity)
--   Period:    period_redemptions / (period_redemptions + equity_at_end)
--

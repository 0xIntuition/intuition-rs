...
impl EventProcessor for &EthMultiVaultV1Events {
    async fn process(
        ...
        match self {
            EthMultiVaultV1Events::SenderApproved(sender_approved_data) => {
            ...
            EthMultiVaultV1Events::SenderRevoked(sender_revoked_data) => {
                let timer = get_event_processing_histogram()
            ...
            EthMultiVaultV1Events::BeforeExecution(before_execution_data) => {
                let timer = get_event_processing_histogram()
            ...
            EthMultiVaultV1Events::UserOperationEvent(user_operation_event_data) => {
                let timer = get_event_processing_histogram()

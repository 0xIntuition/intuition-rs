    ...
    impl BlockIdEncoding {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                BlockIdEncoding::B0xHex => "BLOCK_ID_ENCODING_0X_HEX",
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "BLOCK_ID_ENCODING_0X_HEX" => Some(Self::B0xHex),
...
impl ForkStep {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ForkStep::Unset => "STEP_UNSET",
            ForkStep::New => "STEP_NEW",
            ForkStep::Undo => "STEP_UNDO",
            ForkStep::Final => "STEP_FINAL",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "STEP_UNSET" => Some(Self::Unset),
            "STEP_NEW" => Some(Self::New),
            "STEP_UNDO" => Some(Self::Undo),
            "STEP_FINAL" => Some(Self::Final),
            _ => None,
        }
    }
}

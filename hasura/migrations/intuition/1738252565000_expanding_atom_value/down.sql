...
CREATE TYPE atom_type_new AS ENUM (
  ...
  'Organization', 'OrganizationPredicate', 'Book', 'LikeAction', 'FollowAction', 'Keywords', 'Caip10'
);
...
DROP TABLE ${BACKEND_SCHEMA_NAME}.json_object;
DROP TABLE ${BACKEND_SCHEMA_NAME}.text_object;
DROP TABLE ${BACKEND_SCHEMA_NAME}.byte_object;